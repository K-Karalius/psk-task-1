...
INSERT INTO student_courses (id, student_id, course_id) VALUES (1, 1, 1) ON CONFLICT DO NOTHING;
INSERT INTO student_courses (id, student_id, course_id) VALUES (2, 1, 3) ON CONFLICT DO NOTHING;
INSERT INTO student_courses (id, student_id, course_id) VALUES (3,2, 2) ON CONFLICT DO NOTHING;
INSERT INTO student_courses (id, student_id, course_id) VALUES (4, 2, 4) ON CONFLICT DO NOTHING;
